...
class PathautoKernelTest extends KernelTestBase {
  ...
  public function testGetSchemaAliasMaxLength() {
    $this->assertIdentical(\Drupal::service('pathauto.alias_storage_helper')
  ...
  /**
   * Test the different update actions in
   * \Drupal::service('pathauto.generator')->createEntityAlias().
   */
  ...
  /**
   * Test the handling of path vs non-path tokens in
  ...
  public function testSettingChangeInvalidatesCache() {
    ...
    $this->config('pathauto.settings')->set('enabled_entity_types', [
      'user',
      'entity_test',
    ])->save();
