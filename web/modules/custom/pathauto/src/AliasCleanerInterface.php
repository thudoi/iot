...
interface AliasCleanerInterface {
   ...
   * - Shorten to a desired length and logical position based on word
   * boundaries. This function should *not* be called on URL alias or path
   * strings because it is assumed that they are already clean.
   *
   * @param string $string
   *   A string to clean.
   * @param array $options
   ...
   * including the value and a textual description. Can and should be expanded
   * to include "all" non text punctuation values.
   *
   * @return array
