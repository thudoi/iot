...
/**
 * Provides an 'Simplenews subscription' block with all available newsletters
 * and an email field.
 * @Block(
...
class SimplenewsSubscriptionBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function blockSubmit($form, FormStateInterface $form_state) {
    ...
    $this->configuration['unique_id'] = empty($form_state->getValue('unique_id')) ? \Drupal::service('uuid')
      ->generate() : $form_state->getValue('unique_id');
  }
