...
class SubscriptionsAccountForm extends SubscriptionsFormBase
{
  ...
  public function checkAccess (UserInterface $user)
  {
    ...
    return AccessResult::allowedIfHasPermission($account, 'administer simplenews subscriptions')->orIf(AccessResult::allowedIfHasPermission($account, 'subscribe to newsletters')->andIf(AccessResult::allowedIf($user->id() == $account->id())));
  }
