...
class SimplenewsAdministrationTest extends SimplenewsTestBase
{
  ...
  function testNewsletterSettings ()
  {
    ...
    $edit = ['subscriptions[' . $off_double_newsletter_id . ']' => FALSE,];
    $this->drupalPostForm(NULL, $edit, t('Save'));
  ...
  function testSubscriptionManagement ()
  {
    ...
    $edit = ['name' => $newsletter_name, 'id' => $newsletter_name,];
    ...
    $edit = ['mail' => Unicode::substr(current($subscribers['all']), 0, 4)];
    ...
    $tested_subscribers[2] = $this->randomEmail();
    $edit = ['emails' => implode(', ', $tested_subscribers),];
  ...
  function testContentTypes ()
  {
    ...
    $edit = ['simplenews_content_type' => FALSE,];
