...
interface SubscriberInterface extends ContentEntityInterface {
  ...
  /**
   * Check if the subscriber has an inactive subscription to a certain
   * newsletter.
   *
   * @param string $newsletter_id
   *   The ID of a newsletter.
   *
   * @return bool
   *   Returns TRUE if the subscriber has the inactive subscription, otherwise
   *   FALSE.
   */
  public function isUnsubscribed($newsletter_id);

  /**
   * Check if the subscriber has a subscription to a certain newsletter and
   * return it.
   *
   * @param string $newsletter_id
   *   The ID of a newsletter.
   ...
   *   Returns the subscription item if the subscriber has the subscription,
   *   otherwise FALSE.
   */
