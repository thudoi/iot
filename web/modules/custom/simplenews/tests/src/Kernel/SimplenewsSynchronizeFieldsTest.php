...
class SimplenewsSynchronizeFieldsTest extends KernelTestBase
{
  ...
  public function testSynchronizeBaseFields ()
  {
    ...
    $user = User::create(['name' => 'user', 'mail' => 'user@example.com', 'preferred_langcode' => 'fr',]);
    $user->save();
  ...
  public function testSynchronizeConfigurableFields ()
  {
    ...
    /** @var \Drupal\simplenews\Entity\Subscriber $subscriber */
    $subscriber = Subscriber::create(['field_on_both' => 'foo', 'mail' => 'user@example.com', 'created' => 2000,]);
    $subscriber->save();
    /** @var \Drupal\user\Entity\User $user */
    $user = User::create(['name' => 'user', 'field_on_both' => 'foo', 'mail' => 'user@example.com', 'created' => 1000,]);
    $user->save();
  ...
  public function testSetSharedFieldAutomatically ()
  {
    ...
    /** @var \Drupal\user\Entity\User $user */
    $user = User::create(['name' => 'user', 'field_on_both' => 'foo', 'mail' => 'user@example.com',]);
    $user->save();
    ...
    $subscriber = Subscriber::create(['field_on_both' => 'bar', 'mail' => 'user@example.com',]);
    $subscriber->save();
  ...
  public function testDisableSync ()
  {
    ...
    $subscriber = Subscriber::create(['field_on_both' => 'foo', 'mail' => 'user2@example.com',]);
    $subscriber->save();

    // Create a user.
    $user = User::create(['name' => 'user2', 'mail' => 'user2@example.com',]);
