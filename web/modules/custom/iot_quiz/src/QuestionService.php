...
class QuestionService {
  ...
  public function getOtherTestWS($node)
  {
    $nids = \Drupal::entityQuery('node')
        ...
        ->condition('field_set', $node->get('field_set')->target_id)->execute();
    $nodes = Node::loadMultiple($nids);
    return [
        '#theme' => 'iot_other_test_ws',
        '#nodes' => $nodes,
    ];
  }
  ...
  public function getOtherTestResult($score)
  {
    ...
    $nids = \Drupal::entityQuery('node')
        ...
        ->condition('field_set', $quiz->get('field_set')->target_id)->execute();
    $nodes = Node::loadMultiple($nids);
    return [
        '#theme' => 'iot_other_result',
        '#nodes' => $nodes,
    ];
  }
...
//    $tops = $score_service->get_top_score($quiz_id);
  ...
  public function getTimeStartListening($question)
  {
    ...
    $section_ids = \Drupal::entityQuery('node')->condition('type', 'section')
