...
class TcpPdfExampleController extends ControllerBase
{
  ...
  public function exampleContents ()
  {
    ...
    $page['example_pdf_link'] = ['#title' => $this->t('Basic pdf'), '#type' => 'link', '#url' => Url::fromRoute('tcpdf_example.download_pdf', ['example_name' => 'simple'])];
  ...
  protected function generateSimplePdf ()
  {
    ...
    $html_template = ['#theme' => 'tcpdf_example_basic_html',];
    ...
    */
    $tcpdf->DrupalInitialize(['footer' => ['html' => 'This is a test!! <em>Bottom of the page</em>',], 'header' => ['callback' => ['function' => 'tcpdf_example_default_header', // You can pass extra data to your callback.
