...
abstract class Redirect404TestBase extends WebTestBase
{
   ...
   * @var array
   */
  public static $modules = ['redirect_404', 'node', 'path',];

  /**
   * Permissions for the admin user.
   * @var array
   */
  protected $adminPermissions = ['administer redirects', 'administer redirect settings', 'access content', 'bypass node access', 'create url aliases', 'administer url aliases',];
