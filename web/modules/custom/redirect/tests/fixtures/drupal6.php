...
$connection->schema()->createTable('path_redirect', [
    'fields' => [
      ...
      'query' => ['type' => 'varchar', 'length' => 255, 'not null' => FALSE,],
      'fragment' => ['type' => 'varchar', 'length' => 50, 'not null' => FALSE,],
      'language' => [
        'type' => 'varchar',
        'length' => 12,
        'not null' => TRUE,
      ...
      'type' => ['type' => 'int', 'size' => 'small', 'not null' => TRUE,],
      'last_used' => [
        'type' => 'int',
        'unsigned' => TRUE,
        'not null' => TRUE,
...
$connection->insert('path_redirect')->fields([
  'rid',
  'source',
  'redirect',
  'query',
