...
$connection->schema()->createTable('redirect', [
    'fields' => [
      ...
      'source' => ['type' => 'varchar', 'length' => 255, 'not null' => TRUE,],
      'source_options' => ['type' => 'text', 'not null' => TRUE,],
      'redirect' => ['type' => 'varchar', 'length' => 255, 'not null' => TRUE,],
      'redirect_options' => ['type' => 'text', 'not null' => TRUE,],
      'language' => [
        'type' => 'varchar',
        'length' => 12,
        'not null' => TRUE,
      ...
      'count' => ['type' => 'int', 'not null' => TRUE,],
      'access' => ['type' => 'int', 'not null' => TRUE,],
    ],
    'primary key' => ['rid'],
    'unique keys' => [
...
$connection->insert('redirect')->fields([
  'rid',
  'hash',
  'type',
  'uid',
...
$connection->schema()->createTable('variable', [
    'fields' => [
      ...
      'value' => ['type' => 'blob', 'not null' => TRUE, 'size' => 'normal',],
    ],
    'primary key' => ['name',],
    'mysql_character_set' => 'utf8',
  ]);
...
$connection->insert('variable')
  ->fields(['name', 'value',])
  ->values(['name' => 'redirect_default_status_code', 'value' => 's:3:"307";',])
  ->execute();
...
$connection->schema()->createTable('system', [
    'fields' => [
      ...
      'info' => ['type' => 'blob', 'not null' => FALSE, 'size' => 'normal',],
    ],
