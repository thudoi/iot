...
class Redirect extends ContentEntityBase {
  ...
  public function preSave(EntityStorageInterface $storage_controller) {
    $this->set('hash', Redirect::generateHash($this->redirect_source->path, (array) $this->redirect_source->query, $this->language()
      ->getId()));
  }
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['redirect_source'] = BaseFieldDefinition::create('redirect_source')
      ...
      ->setDisplayOptions('form', ['type' => 'redirect_link', 'weight' => -5,])
    ...
    $fields['redirect_redirect'] = BaseFieldDefinition::create('link')
      ...
      ->setDisplayOptions('form', ['type' => 'link', 'weight' => -4,])
      ->setDisplayConfigurable('form', TRUE);
