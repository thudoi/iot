...
class RedirectRepository
{
  ...
  {
    $ids = $this->manager->getStorage('redirect')->getQuery()->condition('redirect_source.path', $source_path, 'LIKE')->execute();
  ...
  public function findByDestinationUri (array $destination_uri)
  {
    ...
    $ids = $storage->getQuery()->condition('redirect_redirect.uri', $destination_uri, 'IN')->execute();
