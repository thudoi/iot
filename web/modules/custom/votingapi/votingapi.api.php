 ...
 * functions. If your module uses custom tags or value_types, or calculates
 * custom aggregate functions, please implement this hook so other modules can
 * properly interperet and display your data. Three major bins of data are
 * stored: tags, value_types, and aggregate result functions. Each entry in
 * these bins is keyed by the value stored in the actual VotingAPI tables, and
 * contains an array with (minimally) 'name' and
 ...
 * field. Loads all votes for a given piece of content, then calculates and
 * caches the aggregate vote results. This is only intended for modules that
 * have assumed responsibility for the full voting cycle: the
