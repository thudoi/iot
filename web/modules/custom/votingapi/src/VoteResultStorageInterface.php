...
interface VoteResultStorageInterface extends EntityStorageInterface
{
   ...
   * @param int $entity_id the node id of the node for which number of votes is requited.
   * @param string $vote_type Plugin implementing Drupal\votingapi\Plugin\VoteType
